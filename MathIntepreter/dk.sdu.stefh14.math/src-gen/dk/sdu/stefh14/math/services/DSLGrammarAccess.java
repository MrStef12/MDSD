 ...
 */
package dk.sdu.stefh14.math.services;
...
public class DSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MathExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.MathExp");
	...
	public class ExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.Exp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExpOpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.ExpOp");
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.Primary");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ParenthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.Parenthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.stefh14.math.DSL.Number");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("dk.sdu.stefh14.math.DSL".equals(grammar.getName())) {
				return grammar;
			}
